...
List<String> Arti = [
  ...
  'Artinya: "Dengan mengharap ampunanMu, segala puji milik Allah yang telah menghilangkan kotoran dari badanku dan yang telah menyejahterakan."ْ',
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                ...
                colorFilter: ColorFilter.mode(
                    Colors.black26.withOpacity(0.7), BlendMode.luminosity),
                image: AssetImage("images/dek.png")))),
  );
}

topcontent(String namadoa, String arabnya, String artinya) {
...
final HeaderTextStyle = baseTextStyle.copyWith(
    fontSize: 18.0, fontStyle: FontStyle.italic, fontFamily: 'Reemkufi');
